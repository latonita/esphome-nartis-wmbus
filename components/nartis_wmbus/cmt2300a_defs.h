 ...
 *
 * Adapted from anisyanka/cmt2300a library (CMOSTEK SDK register map).
 * Uncommented GPIO_SEL, INT_SEL, INT_EN options; added GO_* mode commands
 * and soft reset register.
 */
...
/* ---------- Mode control commands (CUS_MODE_CTL) ---------- */
...
/* CMT2300A_MASK_INT1_SEL / INT2_SEL options */
