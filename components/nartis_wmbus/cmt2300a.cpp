...
void CMT2300A::apply_fixups_() {
  ...
  this->write_reg(CMT2300A_CUS_IO_SEL, CMT2300A_GPIO3_SEL_INT2 | CMT2300A_GPIO2_SEL_INT1);
...
bool CMT2300A::wait_for_mode_(uint8_t expected_mode, uint32_t timeout_ms) {
  ...
  while (millis() - start < timeout_ms) {
    uint8_t status = this->read_reg(CMT2300A_CUS_MODE_STA) & CMT2300A_MASK_CHIP_MODE_STA;
...
bool CMT2300A::go_standby() {
  ...
  return this->wait_for_mode_(CMT2300A_STA_STBY);
}
